...
(function() {
    ...
    setTimeout(() => {
        ...
        const checks = [
          ...
          {
            includesAny: ['noc-alerts-prod ERROR ', 'noc-escalations-prod ERROR ', 'noc-itsm-sync-prod ERROR ', 'noc-jobs-prod ERROR ', 'appconsole-errors-esb ', 'noc-jobs-daily-prod', 'lvs1esb'],
